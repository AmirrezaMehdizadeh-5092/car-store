...
export default {
  ...
  mounted() {
    this.link2 = window.location.href;
    this.newlink2 = this.link2.substring(30, 54);
    axios
      .post("http://localhost:9856/product2/", {
        link2: this.newlink2,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:9856/product/show_comment2", {
